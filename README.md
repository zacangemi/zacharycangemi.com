...
- [Part 2 commissioning project](https://github.com/zacangemi/local-llm-infrastructure-v2#the-three-part-series) — **Go Big or Go Home, Part 2 — Commissioning the New Threadripper PRO AI Cluster**: CPU, memory, GPU, VRAM, thermals, storage, networking, and recovery validation. **Project starting next.**
