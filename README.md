...
- [`local-llm-inference-lab`](https://github.com/zacangemi/local-llm-inference-lab) — **Go Big or Go Home, Part 2 — The Inference Lab: Multi-Model Benchmarking with vLLM, llama.cpp, and Agentic Workflows**: reproducible performance, context-scaling, multimodal, and agentic evaluation on the V2 server. **Research in progress.**
